...
class MyNet(ME.MinkowskiNetwork):
    ...
    def __init__(self,
      ...
      self.conv5_tr = ME.MinkowskiConvolution(
      ...
      self.conv4_tr = ME.MinkowskiConvolution(
...
#     		row_indices_per_batch=out.coordinate_manager.number_of_unique_batch_indices()
...
# Total params: 12871385
# Trainable params: 12871385
