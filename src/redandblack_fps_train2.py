...
from utils.loss import get_metrics,k_nearest_neighbors,create_dic_fuse
...
def parse_args():
    ...
    parser.add_argument("--dataset_8i", default='/home/jupyter-austin2/pc_dataset/fps_sampling/QP42/redandblack/train/noisyinput/')
    parser.add_argument("--dataset_8i_GT", default='/home/jupyter-austin2/pc_dataset/fps_sampling/QP42/redandblack/train/ground/')
    parser.add_argument("--dataset_8i_val", default='/home/jupyter-austin2/pc_dataset/fps_sampling/QP42/redandblack/val/noisyinput/')
    parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/fps_sampling/QP42/redandblack/val/ground/')
...
#     parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/xyz(fixed)_rgb(noise)/test_val_gt/')
    ...
    parser.add_argument("--prefix", type=str, default='ME_qp42redandblacksampling_30000_noisymodel_xyzunique_y_batchsize8_lr0.001_lrstep12000', help="prefix of checkpoints/logger, etc.")
    ...
    parser.add_argument("--noisyinput_loc", default='/home/jupyter-austin2/pc_dataset/ME_dataset_multiqp/QP42/coord_optimized_unique_align_dataset/')
...
#         print(recfile)
    ...
    for i in range (len(filelist) + 1):
        ...
        if(i == len(filelist) or (filelist[i].split('_')[-3] != current_frame)):
            ...
            noisyinput_file = os.path.join(args.noisyinput_loc, sequence_name, 'val', 'noisyinput', filename+'.'+suffix)
            ...
            with open(rec_file, 'w') as fw:
                file_path = os.path.join(out_path, filelist[start])
                ...
                fw.write('element vertex ' + str(len(fused_pc)) +'\n')
