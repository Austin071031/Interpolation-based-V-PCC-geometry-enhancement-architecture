...
def parse_args():
    ...
    parser.add_argument("--dataset_8i", default='/home/jupyter-austin2/pc_dataset/MIR_Dataset/ply_block42_2048/train/noisyinput/')
    parser.add_argument("--dataset_8i_GT", default='/home/jupyter-austin2/pc_dataset/MIR_Dataset/ply_block42_2048/train/ground/')
    parser.add_argument("--dataset_8i_val", default='/home/jupyter-austin2/pc_dataset/MIR_Dataset/ply_block42_2048/val/noisyinput/')
    parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/MIR_Dataset/ply_block42_2048/val/ground/')
...
#     parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/xyz(fixed)_rgb(noise)/test_val_gt/')
    ...
    parser.add_argument("--prefix", type=str, default='ME_pdgMSELoss_block2048_30000_avgunique_xyz_batchsize8_lr0.001_lrstep12000', help="prefix of checkpoints/logger, etc.")
...
#         emd_loss = pd_loss.get_emd_loss(out_coords.F.unsqueeze(0), coords_T.unsqueeze(0).to(device))
#         repulsion_loss = loss.get_repulsion_loss(out_coords.F.unsqueeze(0))
 
#     + (1 - args.loss_lambda)*repulsion_loss
...
#         print(recfile)
        ...
        with open(recfile, 'w') as f:
            ...
            f.write('element vertex ' + str(len(pc_rec)) + '\n')
...
#                                          repeat=False)
    ...
    result = []
    # Network.
    model = Generator(out_channels=3).to(device)
