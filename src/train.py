...
def parse_args():
    ...
    parser.add_argument("--dataset_8i", default='/home/jupyter-austin2/pc_dataset/ME_dataset_multiqp/universal_xyzoptimize/QP47/ply_block/train/kdtree_noisyinput_optimize_xyzunique/')
    parser.add_argument("--dataset_8i_GT", default='/home/jupyter-austin2/pc_dataset/ME_dataset_multiqp/universal_xyzoptimize/QP47/ply_block/train/kdtree_ground/')
    parser.add_argument("--dataset_8i_val", default='/home/jupyter-austin2/pc_dataset/ME_dataset_multiqp/universal_xyzoptimize/QP47/ply_block/val/kdtree_noisyinput_optimize_xyzunique/')
    parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/ME_dataset_multiqp/universal_xyzoptimize/QP47/ply_block/val/kdtree_ground/')
...
#     parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/xyz(fixed)_rgb(noise)/test_val_gt/')
    ...
    parser.add_argument("--prefix", type=str, default='ME_qp47universal_30000_noisymodel_xyzunique_y_batchsize4_lr0.01_lrstep4000', help="prefix of checkpoints/logger, etc.")
    ...
    parser.add_argument("--test_loss_loc", default='/home/jupyter-austin2/loss/')
...
def train(model, train_dataloader, test_dataloader2, logger, writer, args, device, result):
           ...
           # Evaluation 8i.
            ...
            with torch.no_grad():
                 test1(model=model, test_dataloader=test_dataloader2,
                      logger=logger, writer=writer, writername='eval', step=i, args=args, device=device, saveloss=result)
            torch.cuda.empty_cache()
