...
def parse_args():
    ...
    parser.add_argument("--dataset_8i", default='/home/jupyter-austin2/pc_dataset/self_train/qp47/testsoldier/ply_block_coords_nooptimized/60frames/train/noisyinput/')
    parser.add_argument("--dataset_8i_GT", default='/home/jupyter-austin2/pc_dataset/self_train/qp47/testsoldier/ply_block_coords_nooptimized/60frames/train/ground/')
    parser.add_argument("--dataset_8i_val", default='/home/jupyter-austin2/pc_dataset/self_train/qp47/testsoldier/ply_block_coords_nooptimized/30frames/val/noisyinput/')
    parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/self_train/qp47/testsoldier/ply_block_coords_nooptimized/30frames/val/ground/')
...
#     parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/xyz(fixed)_rgb(noise)/test_val_gt/')
    ...
    parser.add_argument("--prefix", type=str, default='ME_60framestrain_COnoFEU_testsoldier47noloot_30000_noisymodel_xyzunique_y_batchsize8_lr0.001_lrstep12000', help="prefix of checkpoints/logger, etc.")
