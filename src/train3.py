...
from utils.model_structure import model_structure
...
def parse_args():
    ...
    parser.add_argument("--dataset_8i", default='/home/jupyter-austin2/pc_dataset/online_learning/soldier/ply_block/train/kdtree_noisy_optimize_xyzunique/')
    parser.add_argument("--dataset_8i_GT", default='/home/jupyter-austin2/pc_dataset/online_learning/soldier/ply_block/train/kdtree_ground/')
    parser.add_argument("--dataset_8i_val", default='/home/jupyter-austin2/pc_dataset/online_learning/soldier/ply_block/val/kdtree_noisy_optimize_xyzunique/')
    parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/online_learning/soldier/ply_block/val/kdtree_ground/')
...
#     parser.add_argument("--dataset_8i_val_GT", default='/home/jupyter-austin2/pc_dataset/xyz(fixed)_rgb(noise)/test_val_gt/')
    ...
    parser.add_argument("--init_ckpt", default='/home/jupyter-austin2/denoising_model/ME_qp47universal_30000_noisymodel_xyzunique_y_batchsize8_lr0.001_lrstep12000/iter26000.pth')  # ckpts/8x_0x_ks7/iter2000.pth
    parser.add_argument("--reset", default=True, action='store_true', help='reset training')

    parser.add_argument("--lr", type=float, default=0.01)
    parser.add_argument("--batch_size", type=int, default=4)
    parser.add_argument("--global_step", type=int, default=int(500))
    parser.add_argument("--base_step", type=int, default=int(10), help='frequency for recording state.')
    parser.add_argument("--test_step", type=int, default=int(5), help='frequency for test and save.')
    # parser.add_argument("--random_seed", type=int, default=4, help='random_seed.')

    parser.add_argument("--max_norm", type=float, default=0, help='max norm for gradient clip, close if 0')
    ...
    parser.add_argument("--prefix", type=str, default='ME_OLsoldier_500_y_batchsize8_lr0.01_lrstep400_unfreezall', help="prefix of checkpoints/logger, etc.")
    ...
    parser.add_argument("--lr_step", type=int, default=400, help="step for adjusting lr_scheduler.")
...
### yuv
        ...
        coords_gt = ME.SparseTensor(features=y_gt_re, coordinates=coords, device=device, requires_grad=True)
...
#         elif "final" in name:
#             param.requires_grad = True
#         elif "block2_tr.0" in name:
#             param.requires_grad = True
#         elif "block2_tr.1" in name:
#             param.requires_grad = True
#         elif "block2_tr.2" in name:
#             param.requires_grad = True
#         elif "conv2_tr" in name:
#             param.requires_grad = True
#         elif "conv3_tr" in name:
#             param.requires_grad = True
#         elif "block3_tr.0" in name:
#             param.requires_grad = True
#         elif "block3_tr.1" in name:
#             param.requires_grad = True
#         elif "block3_tr.2" in name:
#             param.requires_grad = True
#         else:
